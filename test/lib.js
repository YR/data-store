...
_m_['uuid/rng-browser.js#2.0.2']=(function(module,exports){
...
_m_['uuid/uuid.js#2.0.2']=(function(module,exports){
  module=this;exports=module.exports;
  ...
  var _rng = _m_['uuid/rng-browser.js#2.0.2'];
...
_m_['@yr/time/index.js#3.2.0']=(function(module,exports){
  module=this;exports=module.exports;
...
_m_['superagent/lib/request.js#2.0.0']=(function(module,exports){
  module=this;exports=module.exports;
...
_m_['superagent/lib/is-object.js#2.0.0']=(function(module,exports){
  module=this;exports=module.exports;
...
_m_['superagent/lib/request-base.js#2.0.0']=(function(module,exports){
  module=this;exports=module.exports;

  /**
   * Module of mixed-in functions shared between node and client code
   */
  var isObject = _m_['superagent/lib/is-object.js#2.0.0'];
...
_m_['superagent/lib/client.js#2.0.0']=(function(module,exports){
  module=this;exports=module.exports;
  ...
  var requestBase = _m_['superagent/lib/request-base.js#2.0.0'];
  var isObject = _m_['superagent/lib/is-object.js#2.0.0'];
  ...
  var request = module.exports = _m_['superagent/lib/request.js#2.0.0'].bind(null, Request);
...
_m_['superagent-retry/lib/retries.js#0.6.0']=(function(module,exports){
  module=this;exports=module.exports;
...
_m_['@yr/agent/index.js#4.2.1']=(function(module,exports){
  module=this;exports=module.exports;
  ...
  var Debug = _m_['debug/browser.js#2.2.0'];
  var retryList = _m_['superagent-retry/lib/retries.js#0.6.0'];
  var superagent = _m_['superagent/lib/client.js#2.0.0'];
  
  var STATUS_ABORT = 499;
  ...
  module.exports.abortAll = function abortAll(filter) {
    ...
    for (var key in cache) {
      ...
      if (shouldAbort) {
        ...
        if (!req._callback) delete cache[req.__agentCacheKey];
      }
    }
  };
  ...
  Request.prototype.end = function end(fn) {
    ...
    var onEnd = function onEnd(err, res) {
      ...
      if (err || res.error) {
        if (_this._retries && _this._retries-- && shouldRetry(err, res)) {
          clearTimeout(abortTimeout);
          resetRequest(_this, err.timeout);
          return end();
        }
      ...
      if (res) {
        ...
        debug('request to %s completed in %dms', _this.url, res.duration);
      }
   ...
   * @returns {Request}
   */
  Request.prototype.retry = function retry(count) {
...
_m_['src/index.js']=(function(module,exports){
  ...
  var agent = _m_['@yr/agent/index.js#4.2.1'];
  ...
  var time = _m_['@yr/time/index.js#3.2.0'];
  var uuid = _m_['uuid/uuid.js#2.0.2'];
